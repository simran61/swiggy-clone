...
const Header = () => {
  ...
  return (
    <div className="header flex justify-between items-center px-40 py-4">
      <div className="flex items-center">
        ...
        <button className="flex items-center ml-7">
          <div className="location text-sm">
            <span className="font-bold text-[#3d4152] pb-1 border-b-2 border-b-black">
              Other
            </span>
            <span className="px-2">Indore, Madhya Pradesh, India</span>
          </div>
          <img
            className="h-3"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaaJAni_s_McqO7MEIhoa8mFXCDqWaO6Xupg&s"
            alt=""
          />
        </button>
      </div>
      ...
      <div className="flex items-center">
        <ul className="flex">
          ...
          <li
            className="px-4"
            onClick={() => {
              auth === "Sign In" ? setAuth("Sign Out") : setAuth("Sign In");
            }}
          >
            ...
            <Link to="/cart" className="flex items-center">
              <span className="cart">
                <span className="_3yZyp">
                  ...
                  <span className="_2vS77">{cartItems.length}</span>
                </span>
                <span className="ml-5 text-gray-600 font-medium">Cart</span>
              </span>
            </Link>
          </li>
